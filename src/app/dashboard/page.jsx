              ...
              <div className="relative">
                  ...
                  {creationTime === lastSignInTime && (
                    <div className="flex flex-col gap-5 absolute top-[-40%] lg:top-[-60%] select-none">
                      <p className="relative -rotate-[15deg] text-3xl lg:text-4xl font-cabinSketch text-green-900">Try the Demo Class!</p>
                      <Image src={arrowScribble} alt="" role="presentation" className="absolute bottom-[-90%] left-[90%] translate-x-[-90%] scale-y-[-1] rotate-[55deg]" />
                    </div>
                  )}
              </div>
