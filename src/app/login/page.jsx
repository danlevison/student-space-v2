...
const Login = () => {
    ...
    const scribblesSvgs = [
      ...
      { src: '/assets/Scribbles/37.svg', alt: 'Circle scribble', className: 'absolute bottom-32 md:bottom-1 right-20 w-[75px] md:w-[100px] 2xl:w-[150px]' },
      ...
      { src: '/assets/Scribbles/55.svg', alt: 'Star scribble', className: "absolute bottom-72 right-5 md:right-32 lg:right-56 w-[25px] md:w-[40px]" },
      { src: '/assets/Scribbles/39.svg', alt: 'Triangle scribble', className: "absolute top-72 left-24 md:top-96 2xl:top-80 md:left-72 w-[30px] md:w-[40px]" },
      { src: '/assets/Scribbles/27.svg', alt: 'Pink circles scribble', className: "absolute top-10 right-5 w-[75px] md:w-[100px]" },
      { src: '/assets/Scribbles/9.svg', alt: 'Yellow, pink and red scribble', className: "hidden md:block absolute top-10 w-[100px] 2xl:w-[150px] rotate-180" },
      { src: '/assets/Scribbles/48.svg', alt: 'Black cirlce scribble', className: "hidden md:block absolute bottom-4 2xl:bottom-32 w-[20px] 2xl:w-[25px] rotate-180" },
      ...
      { src: '/assets/Scribbles/28.svg', alt: 'Black squiggle scribble', className: "hidden 2xl:block absolute right-24 lg:right-80 xl:right-96 w-[50px] rotate-180" },
    ]
