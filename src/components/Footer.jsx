...
const Footer = () => {
  ...
  return (
    <footer className="relative w-full h-[560px] bg-[#e3f7fc]">
      ...
      <div>
        <p className="capitalize py-2 text-center absolute bottom-0 left-[50%] translate-x-[-50%]">&copy; {currentYear} all rights reserved | website developed by <Link href={"https://danlevison.vercel.app/"} target="_blank" className="font-bold">Dan Levison</Link></p>
      </div>
    </footer>
  )
}
