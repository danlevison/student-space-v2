...
const AddInstructions = ( {showAddInstructionModal, setShowAddInstructionModal, instruction, setInstruction, addInstruction} ) => {
  
  return (
    <Dialog open={showAddInstructionModal} onClose={() => setShowAddInstructionModal(false)} className="relative z-[100]">
        {/* Backdrop */}
