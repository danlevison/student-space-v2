...
const CopyPasteStudentList = ( {showCopyPasteModal, setShowCopyPasteModal, avatars, studentDob, addedStudents, setAddedStudents, alert, setAlert, alertMessage, setAlertMessage} ) => {
    ...
    const handlePasteStudents = () => {
        ...
        const isDuplicate = validStudentNames.some((name) => addedStudents.some((student) => student.name === name) || studentData.some((student) => student.name === name))
        ...
        <div className="fixed inset-0 flex items-center justify-center p-4">
            ...
            <Dialog.Panel className="w-full max-w-[650px] h-full max-h-[660px] rounded-xl bg-modalBgClr overflow-auto">
                <div className="p-5 flex justify-between items-center">
                    <Dialog.Title className="font-bold text-xl capitalize">Copy/Paste student list</Dialog.Title>
                ...
                <div className="p-5">
                <p className="text-center font-bold mb-5">You can add your students' dates of birth later to display their birthdays.</p>
                {alert ? <p className="font-bold text-red-500 pb-1">{alertMessage}</p> : <label htmlFor="pasteNames" className="pb-1">Paste your student list</label> }
                    <textarea
                    ...
                    <button
                        ...
                        type="button"
                        disabled={!pasteTextAreaRef.current || !pasteTextAreaRef.current.value.trim()}
