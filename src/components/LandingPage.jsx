...
const LandingPage = () => {
  ...
  const scribblesSvgs = [
    { src: '/assets/Scribbles/24.svg', alt: 'Red scribble', className: 'absolute top-10 left-0 w-[75px] md:w-[100px] 2xl:w-[150px]' },
    { src: '/assets/Scribbles/22.svg', alt: 'Red Bolt scribble', className: 'absolute bottom-20 md:bottom-0 right-20 w-[75px] md:w-[100px] 2xl:w-[150px] rotate-12' },
    { src: '/assets/Scribbles/23.svg', alt: 'Black and pink scribble', className: 'absolute top-32 right-6 w-[50px] md:w-[75px] 2xl:w-[100px]' },
    { src: '/assets/Scribbles/21.svg', alt: 'Green scribble', className: "absolute bottom-32 left-16 w-[50px] md:w-[75px]" },
    { src: '/assets/Scribbles/57.svg', alt: 'Arrow scribble', className: "absolute bottom-72 md:bottom-44 2xl:bottom-96 right-7 md:right-56 2xl:right-56 w-[40px] md:w-[50px] 2xl:w-[75px]" },
    { src: '/assets/Scribbles/53.svg', alt: 'Star scribble', className: "absolute top-52 md:top-28 2xl:top-32 w-[25px] 2xl:w-[40px]" },
    { src: '/assets/Scribbles/49.svg', alt: 'Sparkle scribble', className: "absolute bottom-72 left-10 md:left-24 w-[30px] md:w-[40px]" },
    { src: '/assets/Scribbles/45.svg', alt: 'Scratch scribble', className: "hidden 2xl:block absolute top-72 left-72 w-[30px] 2xl:w-[40px]" },
    { src: '/assets/Scribbles/50.svg', alt: 'Green cactus scribble', className: "hidden lg:block absolute bottom-0 w-[100px] 2xl:w-[200px]" },
  ]
  ...
  return (
    <section className="flex flex-col justify-center items-center w-full text-center min-h-screen py-24 relative">
      ...
      <div className="max-w-[1440px] w-full h-full mx-auto p-2 flex flex-col justify-center items-center relative">
        ...
        <h3 className="text-2xl md:text-xl lg:text-2xl text-center pt-10 pb-2 text-secondaryTextClr">Get Started!</h3>
        {user ? 
