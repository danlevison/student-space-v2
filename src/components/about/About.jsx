...
const About = () => {
  return (
    <>
      <section id="about" className="bg-white w-full py-16 lg:py-24 xl:py-40">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-0 px-8">
                <div className="text-secondaryTextClr">
                  <h2 className="text-3xl md:text-4xl lg:text-5xl font-black py-4">
                    <span className="bg-[linear-gradient(#FFF3A0,#FFEB79)] bg-[0_70%] bg-[size:100%_35%] bg-no-repeat">What is Student Space?</span>
                  </h2>
                  <p className="leading-7 font-medium text-tertiaryTextClr py-4">Welcome to Student Space, the ultimate platform designed specifically for primary school teachers by a passionate educator. As an ex-primary school teacher, I understand the importance of an organised and efficient classroom environment that fosters student growth and success. That's why I created <span className="font-bold text-yellow-500">Student Space</span> - your one-stop solution for managing student rewards and facilitating daily classroom management through a single, comprehensive toolkit.</p>
