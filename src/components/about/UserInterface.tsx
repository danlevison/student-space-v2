			...
			<div className="max-w-[1440px] mx-auto px-8">
				<div className="flex flex-col justify-center items-center">
					<div className="md:text-center">
						...
						<p className="text-tertiaryTextClr font-medium leading-7 py-4 w-full md:w-[550px] mx-auto">
							The user-friendly interface ensures that you can effortlessly
							navigate through the app, finding the tools you need with ease.
						</p>
					</div>
