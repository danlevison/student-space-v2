        ...
        <div className="max-w-[1440px] mx-auto px-10">
            <div className="flex flex-col justify-center items-center">
              <div className="text-center">
                  ...
                  <p className="text-tertiaryTextClr leading-7 py-10">Take advantage of intuitive features that make your teaching experience more enjoyable and efficient. Our user-friendly interface ensures that you can effortlessly navigate through the app, finding the tools you need with ease. We have thoughtfully designed Student Space to be accessible on various devices, giving you the freedom to manage your classroom anytime, anywhere.</p>
              </div>
