...
const StudentAvatarMenu = ({
	newStudentAvatar,
	setNewStudentAvatar
}: StudentAvatarMenuProps) => {
	const menuItemData: MenuItemDataType[] = [
		{
	...
	return (
		...
		>
			...
			>
				<Menu.Items className="absolute h-full max-h-[280px] min-h-[30vh] overflow-auto w-[80%] max-w-[420px] left-[50%] translate-x-[-50%] grid grid-cols-[repeat(auto-fill,minmax(80px,1fr))] gap-4 mt-2 p-4 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
