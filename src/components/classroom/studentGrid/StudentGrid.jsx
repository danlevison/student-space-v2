...
const StudentGrid = () => {
    const { studentData, setStudentData, params, showConfetti} = useContext(StudentDataContext)
    ...
    const fetchStudentDataFromFirestore = async () => {
      try {
        ...
        const classDocumentRef = doc(db, "users", user.uid, "classes", params.classroom_id)
